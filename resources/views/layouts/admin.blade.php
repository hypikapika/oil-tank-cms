...
<head>
    ...
    <title>@yield('title', 'CMS OilTankPro')</title>
...
<body class="admin-body">
    <div class="admin-shell">
        <aside class="admin-sidebar">
            <a class="admin-brand" href="{{ route('admin.dashboard') }}">OilTank<span>CMS</span></a>
            <nav class="nav flex-column gap-1">
                <a class="nav-link" href="{{ route('admin.dashboard') }}">Dashboard</a>
                <a class="nav-link" href="{{ route('admin.landing-content.edit') }}">Landing Page</a>
        ...
        <main class="admin-main">
            <header class="admin-topbar">
                <div>
                    <p class="text-muted small mb-1">CMS Internal</p>
